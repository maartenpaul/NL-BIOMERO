...
def server_side_browser_page(request, conn=None, **kwargs):
    ...
    context = {
        'template': 'omeroboost/webclient_plugins/server_side_browser_page.html',
        'user_name': username,
        'user_id': user_id,
        'is_admin': is_admin,
...
def imports_database_page(request, conn=None, **kwargs):
    ...
    context = {
        ...
        'template': 'omeroboost/webclient_plugins/imports_database_page.html',
        'user_name': username,
        'user_id': user_id,
        'is_admin': is_admin
    }
...
def workflows_database_page(request, conn=None, **kwargs):
    ...
    context = {
        'metabase_site_url': metabase_site_url,
        'metabase_token': token,
        'template': 'omeroboost/webclient_plugins/workflows_database_page.html',
        'user_name': username,
        'user_id': user_id,
        'is_admin': is_admin
    }
